...
- `AudioViewModel.kt`: Maneja el flujo de conversión, presets, búsqueda, reproductor y estado del diálogo.
- `AudioConverterEngine.kt`: Realiza las transformaciones de audio en segundo plano mediante Coroutines.
